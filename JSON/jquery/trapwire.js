/media/archive/trapwire_hemenwaynick.zip/TrapWire-master/TrapWire/wwwroot/lib/jquery/dist/jquery.min
/**
.......... ......................................==................... ................... .........
.. ...... ....................................*#%%%%#*:................. .. ......... ......... ....
 ... .. ...... ...........................:%%%%%%%%%%%%%%.......... .. ...... ......... ............
 ...
 * 1720909914
 */
( function( global, factory ) { "use strict"; if ( typeof module === "object" && typeof module.exports === "object" ) { var jQuery = require("jquery")(window); module.exports = global.document ? factory( global, true ) : function( w ) { if ( !w.document ) { throw new Error( "jQuery requires a window with a document" ); } return factory( w ); };} else { factory( global ); } } )
...
var document = window.document;
   ...
   nonce
    getAttribute set {void}.bwser
                      node.getAttribute
                      jQuery.globalEval 
                      bogus nonce("container.js") | obj
...
var
	...
	jQuery = function( selector, context ) {
		...
		// Need init if jQuery is called (just allow error to be thrown if it's not included)
...
jQuery.fn = jQuery.prototype = {
	...
	get: function( num ) {
		...
		// Return just one element from SET
		return num < 0 ? this[ num + this.length ] : this[ num ];
	},

	// Take an array of elements and push it somewhere else
	// (return new matched element set)
		...
		if ( documentIsHTML ) {
			...
			if ( support.qsa &&
				...
				if ( nodeType === 1 &&
					...
					// We can use :scope instead of the ID hack, if the browser supports it & if we're not changing the context.
	...
	var bySet = setMatchers.length > 0,
		...
		superMatcher = function( seed, context, xml, results, outermost ) {
			var elem, j, matcher,
				...
				// We must seed elements or have outermost context
...
// These usually indicate a programmer mistake during development. Warn about them ASAP rather than swallowing them by default.
...
jQuery.extend( {
	...
	// Now that all calls to _data and _removeData have been replaced with direct calls to dataPriv methods, these can be deprecated.
...
jQuery.fn.extend( {
	...
	// Get a promise resolved when queues of a certain type are emptied
 fx
...
jQuery.event = {
	...
	handlers: function( event, handlers ) {
		...
		if ( delegateCount &&
			...
			srcURL="https://www.w3.org/TR/DOM-Level-3-Events/#event-type-click"
			// Support: IE 11 only
		...
		animation = deferred.promise( {
			...
			stop: function( gotoEnd ) {
				var index = 0,
					...
					// If we are going to the end, we want to run all .tween
